	...
	function($){
		...
		$.fn.zTree = {
			...
			init: function(obj, zSetting, zNodes) {
				...
				// });
				// if(zSetting.view)
				// 	zSetting.view.showIcon=function(treeId, treeNode) {return treeNode.level == 0;};
				// else zSetting.view={showIcon:function(treeId, treeNode) {return treeNode.level == 0;}}
