var jscolor = {
	...
	color : function(target, append , prop) {
		...
		function drawPicker(x, y) {
			...
			p.padM.style.background = "url('/Upload/JSColor/cross.gif') no-repeat";
			p.sldM.style.background = "url('/Upload/JSColor/arrow.gif') no-repeat";
			p.pad.style.background = "url('/Upload/JSColor/" + padImg + "') 0 0 no-repeat";
			// place pointers
			redrawPad();
			redrawSld();
